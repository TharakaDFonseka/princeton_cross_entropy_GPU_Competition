...
Benchmark settings (fixed by the course): **batch size B = 4,096**, **bfloat16** logits, vocabulary sizes **V ∈ {32000, 50264, 128256}**. Runs target an **NVIDIA A100 (80 GB)**-class setup.
